...
public extension CaamDau where Base: UIScrollView {
    ...
    @discardableResult
    func headerMJWithModel(_ block:@escaping MJRefreshComponentRefreshingBlock, model:RefreshModel = Refresh.shared.model, custom:((MJRefreshNormalHeader?)->Void)? = nil) -> CaamDau {
    ...
    /// 添加Gif下拉
    @discardableResult
    func headerMJGifWithModel( _ block:@escaping MJRefreshComponentRefreshingBlock, model:RefreshModel = Refresh.shared.model, custom:((MJRefreshGifHeader?)->Void)? = nil) -> CaamDau {
    ...
    /// 添加默认上拉
    @discardableResult
    func footerMJBack( _ block:@escaping MJRefreshComponentRefreshingBlock, model:RefreshModel = Refresh.shared.model, custom:((MJRefreshBackNormalFooter?)->Void)? = nil) -> CaamDau {
    ...
    /// 添加默认上拉
    @discardableResult
    func footerMJBackWithModel( _ block:@escaping MJRefreshComponentRefreshingBlock, model:RefreshModel = Refresh.shared.model, custom:((MJRefreshBackNormalFooter?)->Void)? = nil) -> CaamDau {
        let mj = MJRefreshBackNormalFooter(refreshingBlock: block)
        self.footer(withBack: mj, model: model)
        custom?(mj)
        base.mj_footer = mj
    ...
    /// 添加默认上拉 - 自动刷
    @discardableResult
    func footerMJAutoWithModel(_ block:@escaping MJRefreshComponentRefreshingBlock, model:RefreshModel = Refresh.shared.model, custom:((MJRefreshAutoNormalFooter?)->Void)? = nil) -> CaamDau {
        let mj = MJRefreshAutoNormalFooter(refreshingBlock: block)
    ...
    /// 添加Gif上拉
    @discardableResult
    func footerMJGifBackWithModel( _ block:@escaping MJRefreshComponentRefreshingBlock, model:RefreshModel = Refresh.shared.model, custom:((MJRefreshBackGifFooter?)->Void)? = nil) -> CaamDau {
    ...
    /// 添加Gif上拉 - 自动刷
    @discardableResult
    func footerMJGifAutoWithModel( _ block:@escaping MJRefreshComponentRefreshingBlock, model:RefreshModel = Refresh.shared.model, custom:((MJRefreshAutoGifFooter?)->Void)? = nil) -> CaamDau {
    ...
    /// 设置刷新状态
    @discardableResult
    func mjRefreshTypes(_ types:[RefreshModel.RefreshType]) -> CaamDau {
        var types = types
